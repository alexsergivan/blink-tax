export type ShareCardData = { seconds: number; isNewBest: boolean; best: number };
const WIDTH = 1080;
const HEIGHT = 1920;
...
export async function generateShareCard({ seconds, isNewBest, best }: ShareCardData): Promise<Blob> {
  ...
  c.fillStyle = '#ffed00'; roundedRect(c, 70, 1170, 940, 160, 10); c.fillStyle = '#111'; const line = punchline(seconds); const lineSize = fitText(c, line, 850, 74); c.fillText(line, 112, 1270);
  ...
  c.fillStyle = '#111'; c.fillRect(70, 1690, 940, 3); c.font = '700 28px "Space Mono", monospace'; c.fillText('blink-tax.com  /  @BLINKTAX', 76, 1765); c.font = '400 25px "Space Mono", monospace'; c.fillText('I blinked. I paid. Your turn.', 76, 1820);
